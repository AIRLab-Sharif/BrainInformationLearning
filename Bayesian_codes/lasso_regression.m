function [B_final,constant_term,R_max,lasso_mse,m_optimal,lambda_min_mse]=lasso_regression(X,stimuli,m_min,m_max,m_step,lambda_min,lambda_max,lambda_step,ep,n,permutation)
%n equals to 3
...
%     end
    ...
    min_mse_lasso = info1.MSE(info1.IndexMinMSE);
    B_min_mse = B(:,info1.IndexMinMSE);
    ...
    if R>R_max
        ...
        m_optimal = m;
        constant_term = info1.Intercept(info1.IndexMinMSE);
        lambda_min_mse = info1.Lambda1SE;
    end
end
end